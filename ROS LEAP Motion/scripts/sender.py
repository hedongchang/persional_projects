...
def sender():
    ...
    while not rospy.is_shutdown():
        ...
        a=msg.palmpos.x = hand_palm_pos_[0]
        b=msg.palmpos.y = hand_palm_pos_[1]
        c=msg.palmpos.z = hand_palm_pos_[2]
        #msg.ypr.x = hand_yaw_
        ...
        rospy.sleep(0.01)
	msg.palmpos.x=hand_palm_pos_[0]-a;
	msg.palmpos.y=hand_palm_pos_[1]-b;
	msg.palmpos.z=hand_palm_pos_[2]-c;
	pub_ros.publish(msg)
